...
export class MatchService extends BaseService {
  ...
  matchControllerGetUserMatches$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MatchService.MatchControllerGetUserMatchesPath, 'get');
    if (params) {
    }
  ...
  matchControllerCreateMatch$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MatchService.MatchControllerCreateMatchPath, 'post');
    if (params) {
  ...
  matchControllerGetMatch$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MatchService.MatchControllerGetMatchPath, 'get');
    if (params) {
  ...
  matchControllerSubmitMove$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MatchService.MatchControllerSubmitMovePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  matchControllerJoinMatch$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MatchService.MatchControllerJoinMatchPath, 'patch');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  matchControllerGetJoinAbleMatches$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MatchService.MatchControllerGetJoinAbleMatchesPath, 'get');
    if (params) {
    }
